        ...
        <div className="border-2 border-white w-[90%] m-auto h-[75%] flex flex-col rounded-2xl">
          <div className=" h-[60%] border-b-2 flex flex-col md:flex-row">
            ...
            <div className="w-[100%] h-full flex">
              <img src="/assets/image.webp" className="w-[100%] " alt="" />
              <div className="text-white md:flex md:flex-col gap-4 text-center px-4 bebas-neue-regular text-[18px] hidden">
                <div><h1 className="mt-4">PROJECTS </h1>
                <h2 className="text-xl">5 +</h2>
                </div>
                <div className="border-t-2 border-[#F1F660]"><h1 className="mt-2">CLIENT SATISFACTION </h1>
                <h2>⭐⭐⭐⭐</h2>
                </div>
                <div className="border-t-2 border-[#F1F660]"><h1 className="mt-2">DESIGNS DELIVERED </h1>
          ...
          <div className="h-[40%] flex">
            <div className="w-1/2 h-full border-r-2 flex justify-center items-center">
              <h1 className="text-md md:text-2xl lg:text-4xl anton-sc-regular text-center px-3 text-[#faf4da]">
                NEXACRFT IS A <span style={{color: "rgb(241, 246, 96)"}}>CREATIVE</span> SERVICE AND WEBSITE AGENCY PROVIDING
                <span style={{color: "rgb(241, 246, 96)"}}> EXCEPTIONAL</span> WEBSITE EXPERIENCES.
              </h1>
            </div>
            <div className="w-1/2 h-full flex justify-center items-center flex-col">
              <h2 className="font-semibold px-3 md:px-6 text-[10px] md:text-[14px] lg:text-[16px]"> we bring the elements you need together to create a perfectly balanced creative team. This tailor-made blend allows us to take your ideas and forge them into gold. </h2>
