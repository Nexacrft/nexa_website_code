...
const Flashcard = ({ number, quote, desc, icon }) => {
  return (
<div class="card">
  ...
  <div class="card-image">
    <svg width="24" viewBox="0 -960 960 960" height="24" xmlns="http://www.w3.org/2000/svg"><path d="m393-165 279-335H492l36-286-253 366h154l-36 255Zm-73 85 40-280H160l360-520h80l-40 320h240L400-80h-80Zm153-395Z"></path></svg>
  </div>
</div>
  )
}
